...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_idb__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_idb___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_idb__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_polyfill__ = __webpack_require__(133);
...
class CurrencyController {
    ...
    openDB() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_idb___default.a.open('converter', 2, upgradeDb => {
    ...
    getCurrencies() {
        ...
        fetch('https://free.currencyconverterapi.com/api/v5/currencies').then(function (response) {
            ...
            DB.then(function (db) {
                ...
                console.log(arr);
                arr.forEach(element => {
                    currenciesStore.put(Object.assign({}, Obj.results[element], {
                        id: element
                    }));
                });
                return tx.complete;
...
module.exports = __webpack_require__(38) || !__webpack_require__(11)(function () {
  var K = Math.random();
...
__webpack_require__(19)(IteratorPrototype, __webpack_require__(13)('iterator'), function () { return this; });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(19)(proto, TO_PRIMITIVE, __webpack_require__(217));
...
$export($export.P + $export.F * (__webpack_require__(54) != Object || !__webpack_require__(29)(arrayJoin)), 'Array', {
...
__webpack_require__(14) && $export($export.P + __webpack_require__(69), 'Object', {
